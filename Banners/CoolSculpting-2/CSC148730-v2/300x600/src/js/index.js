...
(function() {
    ...
    nameSpace.init = function() {
        ...
        gsap.set(["#copy-2", "#copy-1", "#cta", "#legal"], {
            x: 0,
            autoAlpha: 0,
        });
    ...
    nameSpace.initAnimation = function() {
        ...
        timeline
            ...
            .to(
                ["#copy-1", "#legal", "#bg-1"], { duration: 1, autoAlpha: 1, x: -width, ease: Linear.None },
                "+=7"
            )

        .to(["#bg"], { duration: 1, x: 0, ease: Linear.None }, "-=1")
            .to(
