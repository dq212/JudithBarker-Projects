...
(function() {
    ...
    var scrollContentHandler = function() {
        window.requestAnimationFrame(function() {
            thumb.style.top =
                ((content.scrollTop / (1 - thumbRatio)) * 100) / content.scrollHeight +
                "%";
        });
    };
    ...
    nameSpace.initAnimation = function() {
        ...
        timeline
            .to(
                ["#copy-1"], { duration: 1, autoAlpha: 1, ease: Power2.easeOut },
                "+=0"
            )
            .to(
                ["#cta"], { duration: 1, autoAlpha: 1, ease: Power2.easeOut },
                "-=0.5"
            )
            .to(
                ["#copy-1"], { duration: 1, autoAlpha: 0, ease: Power2.easeOut },
                "+=4"
            )
            .to(
                ["#copy-2"], { duration: 1, autoAlpha: 1, ease: Power2.easeOut },
                "-=0.5"
            )
            .to(
            ...
            .to(
                ["#copy-2", "#legal"], { duration: 1, autoAlpha: 0, ease: Power2.easeOut },
                "+=5.5"
            )

        .to(
            ["#copy-3"], { duration: 1, autoAlpha: 1, ease: Cubic.easeInOut },
            "+=0"
        );
        // .to(
        //     ["#cta"], { duration: 1, autoAlpha: 1, ease: Cubic.easeInOut },
        //     "+=0.5"
        // );
    };
