...
(function() {
    ...
    nameSpace.initAnimation = function() {
        ...
        timeline
            .to(
                ["#copy-1", "#legal"], { duration: 1, autoAlpha: 1, x: -width, ease: Power2.easeOut },
                "+=5"
            )
            .to(
                ["#footnote", "#bg-1"], { duration: 0.5, x: -width, ease: Power2.easeIn },
                "-=0.5"
            )
            .to(
                ["#footnote", "#bg"], { duration: 0.5, x: 0, ease: Power2.easeInOut },
                "-=0.5"
            )
            .to(
